    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          addLesson(lessonTitleController.text, typeController.text, newColorCode, place.text, dateController.text, selectedGroupId,timeController.text.replaceAll(' ', '')).then((response){
